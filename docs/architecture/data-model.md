...
> **全シグナル共通の前提条件（2026-08-23追加。2026-09-19、CHG-0018／ADR-0016で(1)をOR条件に改訂、use-cases.md UC-010業務ルール参照）**: 長期低迷銘柄・個別要因での下落銘柄を誤って拾わないよう、8種いずれのシグナルも(1)(2)両方を満たした場合のみ検出する。
