{{--
    ...
    列を増減・変更する場合は、呼び出し側テーブルの固定幅（w-[1482px]）も必ず同時に更新すること
    （CHG-0012で売買シグナル画面のw-[1440px]→w-[1512px]を更新した先例と同じ。PER/PBRの生数値列は
    2026-09-21マージ時にCHG-0018の判定チェックリストPER/PBRチップと重複するため削除した）。
--}}
